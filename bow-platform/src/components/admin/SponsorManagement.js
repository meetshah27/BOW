...
const SponsorManagement = () => {
  ...
  // Removed uploading state monitoring

  // Debug: Monitor form data changes
  useEffect(() => {
    console.log('📝 Form data changed:', formData);
    console.log('📝 Button should be disabled:', saving || !formData.name || !formData.logoUrl);
  }, [formData, saving]);
  ...
  const handleFileUpload = (fileData) => {
    console.log('🔄 handleFileUpload called with:', fileData);
    
    if (fileData && fileData.url) {
      console.log('📤 File upload successful:', fileData);
      console.log('📤 Setting logoUrl to:', fileData.url);
  ...
  const handleCreate = async (e) => {
    ...
    if (!formData.name || !formData.logoUrl) {
      console.log('❌ Validation failed - missing name or logoUrl');
      console.log('Name:', formData.name);
      console.log('LogoUrl:', formData.logoUrl);
    ...
    setSaving(true);
    try {
      console.log('🚀 Sending sponsor data to API:', formData);
