          ...
          <div key={sponsor.id} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            <div className="p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-semibold text-gray-900 truncate">Sponsor</h3>
              ...
              <form onSubmit={handleCreate} className="space-y-4">
                ...
                <div>
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      console.log('🧪 Setting test logo URL');
                      setFormData(prev => ({
                        ...prev,
                        logoUrl: 'https://via.placeholder.com/300x150/4F46E5/FFFFFF?text=Test+Logo'
                      }));
                      toast.success('Test logo URL set!');
                    }}
                  ...
                  {formData.logoUrl && (
                    <div className="mt-2 p-2 bg-green-50 rounded-lg flex items-center">
                      ...
                      <span className="text-sm text-green-800">Logo URL set: {formData.logoUrl}</span>
                    </div>
                  )}
                </div>
...
export default SponsorManagementFixed;
