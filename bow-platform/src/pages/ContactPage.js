...
const ContactPage = () => {
  ...
  return (
    <>
      ...
      {/* Contact Information */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-white via-blue-50 to-indigo-50 relative overflow-hidden">                                                
        {/* Enhanced background decorative elements */}
        <div className="absolute inset-0 opacity-15">
          <div className="absolute top-20 right-20 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 bg-gradient-to-r from-primary-200 to-secondary-200 rounded-full blur-3xl floating-bg animate-pulse"></div>                                                                         
          <div className="absolute bottom-20 left-20 w-24 h-24 sm:w-36 sm:h-36 md:w-48 md:h-48 bg-gradient-to-r from-secondary-200 to-primary-200 rounded-full blur-2xl floating-bg animate-pulse" style={{animationDelay: '2s'}}></div>                                        
          <div className="absolute top-1/2 left-1/4 w-16 h-16 sm:w-24 sm:h-24 md:w-32 md:h-32 bg-gradient-to-r from-pink-200 to-purple-200 rounded-full blur-2xl floating-bg animate-pulse hidden sm:block" style={{animationDelay: '4s'}}></div>                                               
          <div className="absolute top-1/3 right-1/4 w-20 h-20 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-gradient-to-r from-yellow-200 to-orange-200 rounded-full blur-3xl floating-bg animate-pulse hidden md:block" style={{animationDelay: '6s'}}></div>                                            
        </div>
        ...
        <div className="container-custom relative z-10 px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16 md:mb-20 animate-fade-in-up">
            <div className="inline-block mb-6 sm:mb-8 relative">
              ...
              <div className="relative w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-2xl transform hover:scale-110 transition-all duration-500">               
                <MessageCircle className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 text-white animate-pulse" />
              </div>
              <div className="absolute -top-2 -right-2 w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center">     
                <Sparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-white animate-spin" />        
              </div>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6 md:mb-8 bg-gradient-to-r from-primary-600 via-secondary-600 to-primary-600 bg-clip-text text-transparent animate-text-shine px-2">                                                          
              Contact Information
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl border border-white/50 group-hover:shadow-3xl transition-all duration-700 transform group-hover:rotate-1">                                      
                  {/* Decorative corner elements */}
                  <div className="absolute top-2 right-2 w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-r from-primary-300 to-secondary-300 rounded-full opacity-50 group-hover:opacity-100 transition-all duration-500 animate-pulse"></div>                           
                  <div className="absolute bottom-2 left-2 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gradient-to-r from-secondary-300 to-primary-300 rounded-full opacity-50 group-hover:opacity-100 transition-all duration-500 animate-pulse" style={{transitionDelay: '0.2s'}}></div>                                                                       

                  <div className="relative flex justify-center mb-4 sm:mb-6">
                    <div className={`w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 bg-gradient-to-br ${info.bgColor} rounded-xl sm:rounded-2xl flex items-center justify-center shadow-2xl transform transition-all duration-500 scale-110 ${info.title === "Office Hours" ? "" : "rotate-3"} group-hover:scale-125 ${info.title === "Office Hours" ? "group-hover:rotate-3" : "group-hover:rotate-12"} group-hover:shadow-3xl relative overflow-hidden animate-bounce`} style={{animationDuration: '3s', animationDelay: `${index * 0.5}s`}}>    
                      {/* Shimmer effect */}
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent transform -skew-x-12 animate-shimmer"></div>                                                                               
                      <info.icon className={`w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 text-white relative z-10 ${info.title === "Office Hours" ? "animate-spin" : ""}`} style={info.title === "Office Hours" ? {animationDuration: '4s', animationDelay: `${index * 0.3}s`} : {}} />                                                                           
                    </div>
                  </div>

                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3 group-hover:text-primary-600 transition-colors duration-500">                             
                  {info.title}
                </h3>
                  ...
                  {info.link ? (
                    <a
                      href={info.link}
                      className={`text-sm sm:text-base text-gray-600 hover:${info.iconColor} transition-all duration-300 hover:scale-105 inline-block font-medium group/link break-words`}       
                    >
                    ...
                    <p className="text-sm sm:text-base text-gray-600 font-medium break-words">{info.value}</p>   
                  )}

                  {/* Hover indicator */}
                  <div className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-10 sm:w-12 h-0.5 sm:h-1 bg-gradient-to-r ${info.bgColor} group-hover:w-14 sm:group-hover:w-16 transition-all duration-500 rounded-full animate-pulse`} style={{animationDelay: `${index * 0.2}s`}}></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden">                                                  
        ...
        <div className="absolute inset-0 opacity-15">
          <div className="absolute top-20 right-20 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 bg-gradient-to-r from-primary-200 to-secondary-200 rounded-full blur-3xl floating-bg animate-pulse"></div>                                                                         
          <div className="absolute bottom-20 left-20 w-24 h-24 sm:w-36 sm:h-36 md:w-48 md:h-48 bg-gradient-to-r from-secondary-200 to-primary-200 rounded-full blur-2xl floating-bg animate-pulse" style={{animationDelay: '2s'}}></div>                                        
          <div className="absolute top-1/2 right-1/4 w-20 h-20 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-gradient-to-r from-green-200 to-blue-200 rounded-full blur-3xl floating-bg animate-pulse hidden md:block" style={{animationDelay: '4s'}}></div>                                               
        </div>
        ...
        <div className="container-custom relative z-10 px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 lg:p-10 border border-white/50 transform transition-all duration-700 hover:scale-105 hover:shadow-3xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-6 sm:mb-8">
                  <div className="relative">
                    ...
                    <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-xl sm:rounded-2xl flex items-center justify-center mr-3 sm:mr-4 md:mr-6 shadow-xl transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-6">                                                                        
                      <Send className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" />
                    </div>
                  </div>
                  <div>
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">          
                    Send us a Message
                  </h2>
                    <p className="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2">We'd love to hear from you! ✨</p>                                                                       
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6 md:space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                    <div className="group relative">
                      <label htmlFor="name" className="block text-xs sm:text-sm font-bold text-gray-700 mb-2 sm:mb-3 group-hover:text-primary-600 transition-colors duration-300 flex items-center">
                        <Star className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 text-primary-500" />
                        Full Name *
                      </label>
                      <div className="relative">
                      <input
                        ...
                        required
                          className="w-full px-4 sm:px-5 md:px-6 py-3 sm:py-3.5 md:py-4 text-sm sm:text-base border-2 border-gray-200 rounded-xl sm:rounded-2xl focus:ring-4 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-300 hover:border-primary-300 hover:shadow-lg bg-white/80 backdrop-blur-sm text-gray-900 placeholder-gray-500 font-medium"                    
                        placeholder="Enter your full name"
                      />
                        <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-r from-primary-500/10 to-secondary-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>                     
                      </div>
                    </div>
                    <div className="group relative">
                      <label htmlFor="email" className="block text-xs sm:text-sm font-bold text-gray-700 mb-2 sm:mb-3 group-hover:text-primary-600 transition-colors duration-300 flex items-center">                                                              
                        <Mail className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 text-primary-500" />      
                        Email Address *
                      </label>
                      <div className="relative">
                      <input
                  ...
                  <div className="group relative">
                    <label htmlFor="subject" className="block text-xs sm:text-sm font-bold text-gray-700 mb-2 sm:mb-3 group-hover:text-primary-600 transition-colors duration-300 flex items-center">                                                              
                      <MessageCircle className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 text-primary-500" />                                                                               
                      Subject *
                    </label>
                    <div className="relative">
                    <input
                  ...
                  <div className="group relative">
                    <label htmlFor="message" className="block text-xs sm:text-sm font-bold text-gray-700 mb-2 sm:mb-3 group-hover:text-primary-600 transition-colors duration-300 flex items-center">                                                              
                      <MessageCircle className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 text-primary-500" />                                                                               
                      Message *
                    </label>
                    <div className="relative">
                    <textarea
                      ...
                      required
                      rows={5}
                        className="w-full px-4 sm:px-5 md:px-6 py-3 sm:py-3.5 md:py-4 text-sm sm:text-base border-2 border-gray-200 rounded-xl sm:rounded-2xl focus:ring-4 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-300 hover:border-primary-300 hover:shadow-lg bg-white/80 backdrop-blur-sm text-gray-900 placeholder-gray-500 font-medium resize-none"          
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-primary-600 via-secondary-600 to-primary-600 text-white text-base sm:text-lg md:text-xl py-3 sm:py-4 md:py-5 px-6 sm:px-7 md:px-8 rounded-xl sm:rounded-2xl font-bold transform transition-all duration-500 hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-primary-500/30 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group/btn"                                
                  >
                    ...
                    <div className="relative flex items-center justify-center"> 
                      {loading ? (
                        <>
                          ...
                          <span className="text-sm sm:text-base md:text-lg">Sending your message...</span>                                                                              
                        </>
                      ) : (
                        <>
                          <Send className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 group-hover/btn:scale-110 group-hover/btn:rotate-12 transition-transform duration-300" />               
                          <span className="text-sm sm:text-base md:text-lg">Send Message</span>
                          <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 ml-1.5 sm:ml-2 group-hover/btn:animate-spin transition-all duration-300" />                                        
                        </>
                      )}
                    </div>
                  </button>
            ...
            <div className="animate-fade-in-up" style={{animationDelay: '0.3s'}}>                                                                               
              <div className="flex items-center mb-6 sm:mb-8">
                <div className="relative">
                  ...
                  <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-secondary-500 to-primary-500 rounded-xl sm:rounded-2xl flex items-center justify-center mr-3 sm:mr-4 md:mr-6 shadow-xl transform transition-all duration-500 hover:scale-110 hover:rotate-6">      
                    <Users className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" />
                  </div>
                </div>
                <div>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 bg-gradient-to-r from-secondary-600 to-primary-600 bg-clip-text text-transparent">            
                  Contact by Department
                </h2>
                  <p className="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2">Connect with the right team! 🎯</p>                                                                       
                </div>
              </div>
              ...
              <div className="space-y-4 sm:space-y-6 md:space-y-8">
                {departments.map((dept, index) => (
                  <div
                    key={index}
                    className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl border border-white/50 transform transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:shadow-2xl group cursor-pointer relative overflow-hidden"                                                                         
                    style={{animationDelay: `${index * 0.15}s`}}
                  >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                          <div className="flex items-center mb-3 sm:mb-4">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-lg sm:rounded-xl flex items-center justify-center mr-3 sm:mr-4 shadow-lg transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-6 flex-shrink-0">                                                                          
                              <Users className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                            </div>
                            <h3 className="text-lg sm:text-xl font-bold text-gray-900 group-hover:text-primary-600 transition-colors duration-300 break-words">                        
                          {dept.name}
                        </h3>
                          </div>
                          <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 group-hover:text-gray-700 transition-colors duration-300 leading-relaxed break-words">                           
                          {dept.description}
                        </p>
                        <a
                          href={`mailto:${dept.email}`}
                            className="text-sm sm:text-base text-primary-600 hover:text-primary-700 font-bold inline-flex items-center group-hover:scale-105 transition-all duration-300 bg-primary-50 hover:bg-primary-100 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg sm:rounded-xl break-all"                    
                        >
                            <Mail className="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2 flex-shrink-0 group-hover:translate-x-1 transition-transform duration-300" />                                       
                          <span className="break-all">{dept.email}</span>
                        </a>
                      </div>
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-primary-100 to-secondary-100 rounded-lg sm:rounded-xl flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:scale-110 group-hover:rotate-12 flex-shrink-0 ml-2">                                                          
          ...
          <div className="flex justify-center space-x-8">
            {socialLinks.map((social, index) => (
              ...
              >
                ...
                <social.icon className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 relative z-10 group-hover:scale-125 group-hover:rotate-12 transition-transform duration-500" />               

                {/* Hover indicator */}
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 sm:h-1 bg-white/60 group-hover:w-12 sm:group-hover:w-16 transition-all duration-500 rounded-full"></div>                                                                     
              </a>
            ))}
          </div>

          {/* Additional call to action */}
          <div className="mt-10 sm:mt-12 md:mt-16 bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl border border-white/50 max-w-2xl mx-auto">                               
            <div className="flex items-center justify-center mb-3 sm:mb-4">
              <Globe className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-primary-600 mr-2 sm:mr-3" />
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900">Join Our Global Community</h3>                                                                   
            </div>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-700 hover:scale-105 hover:shadow-3xl border border-white/50 relative group">
            ...
            {/* Map info overlay */}
            <div className="absolute bottom-2 left-2 right-2 sm:bottom-4 sm:left-4 sm:right-4 bg-white/90 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 shadow-lg border border-white/50 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">              
              <div className="flex items-center">
                <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-primary-600 mr-2 sm:mr-3 flex-shrink-0" />
                <div className="min-w-0">
                  <p className="text-sm sm:text-base font-bold text-gray-900 break-words">Beats of Washington Office</p>                                                                         
                  <p className="text-xs sm:text-sm text-gray-600 break-words">9256 225th Way NE, WA 98053</p>  
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/50 transform transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:shadow-2xl group cursor-pointer relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-sm sm:text-base text-gray-600 group-hover:text-gray-700 transition-colors duration-300 leading-relaxed break-words">                                        
                  ...
                  {/* Progress indicator */}
                  <div className="absolute bottom-0 left-0 w-0 h-0.5 sm:h-1 bg-gradient-to-r from-primary-500 to-secondary-500 group-hover:w-full transition-all duration-500 rounded-full"></div>                                                       
                </div>
              </div>

              <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl border border-white/50 transform transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:shadow-2xl group cursor-pointer relative overflow-hidden">                                                                         
                {/* Enhanced background effects */}
                <div className="absolute inset-0 bg-gradient-to-r from-primary-500/5 to-secondary-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>                                                               
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-primary-100 to-secondary-100 rounded-full blur-2xl opacity-0 group-hover:opacity-60 transition-all duration-500"></div>                                 

                {/* Decorative corner elements */}
                <div className="absolute top-3 right-3 w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-secondary-300 to-primary-300 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500 animate-pulse"></div>                              

                <div className="relative z-10">
                  <div className="flex items-center mb-3 sm:mb-4">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-secondary-500 to-primary-500 rounded-lg sm:rounded-xl flex items-center justify-center mr-3 sm:mr-4 shadow-lg transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-6 flex-shrink-0">  
                  ...
                  {/* Progress indicator */}
                  <div className="absolute bottom-0 left-0 w-0 h-0.5 sm:h-1 bg-gradient-to-r from-secondary-500 to-primary-500 group-hover:w-full transition-all duration-500 rounded-full"></div>                                                       
                </div>
              </div>
            </div>

            <div className="space-y-4 sm:space-y-6 md:space-y-8 animate-fade-in-up" style={{animationDelay: '0.4s'}}>                                                                     
              <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl border border-white/50 transform transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:shadow-2xl group cursor-pointer relative overflow-hidden">                                                                         
                {/* Enhanced background effects */}
                <div className="absolute inset-0 bg-gradient-to-r from-primary-500/5 to-secondary-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>                                                               
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-primary-100 to-secondary-100 rounded-full blur-2xl opacity-0 group-hover:opacity-60 transition-all duration-500"></div>                                 
                ...
                {/* Decorative corner elements */}
                <div className="absolute top-3 right-3 w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-primary-300 to-secondary-300 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500 animate-pulse"></div>                              
